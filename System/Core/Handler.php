...
class CoreHandler
{
	...
	/**
	 *	Called when a user enters a channel.
	 *	Numeric: 333 - Topic information. (Thanks, bpeterson)
	 */
	...
	{
		$pInstance->Raw("WHO {$pMessage->Parts[3]}");
	}
	...
	public static function Kick(CoreMaster $pInstance, MessageObject $pMessage)
	{
		...
		$pAdmin = $pInstance->getUser($pMessage->User);
	...
	{
		$pSender = $pInstance->getUser($pMessage->User);
