...
trait Delegator
{
    ...
    final public function &__get($property)
    {
        ...
        $property = ctype_digit($property) ? (int) $property : $property;
     ...
     */
    final protected function &invokeGetter($property)
    {
        $reflector = $this->reflector();
     ...
     *	See further: [const OC_MAGIC_IN_CONTAINER]
     */
    final protected function invokeSetter($property, $value)
    {
        $reflector = $this->reflector();
     ...
     *	See further: [const OC_MAGIC_IN_CONTAINER]
     */
    final protected function invokeIsset($property)
    {
        $reflector = $this->reflector();
     ...
     *	See further: [const OC_MAGIC_IN_CONTAINER]
     */
    final protected function invokeUnset($property)
    {
        $reflector = $this->reflector();
