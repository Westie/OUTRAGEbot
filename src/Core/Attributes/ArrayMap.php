...
trait ArrayMap
{
     ...
     */
    final public function pop($value)
    {
     ...
     */
    final public function slice($offset = 0, $length = null, $preserve_keys = false)
    {
     ...
     *	internal pointer.
     */
    final public function splice($offset, $length = 0, $replacement = null)
    {
     ...
     */
    final public function map($callback = null)
    {
